...
}else if(str_contains($_SERVER['REQUEST_URI'], 'vn')){
    $language = "vn";
...
if($_SERVER['REQUEST_URI'] == '/etimesolution.com/en/'){
    ...
    <div class="body" style="display: flex; width: 100%;">
        <div class="menu" style="width: 100px; height: 100vh; background-color: #3d3c3c; position: fixed; margin-top: 5.2%;">
            <ul>
                ...
                <li class="<?php if(str_contains($_SERVER['REQUEST_URI'], "timer")){ echo "active"; } ?>">
            ...
            <li class="<?php if(str_contains($_SERVER['REQUEST_URI'], "stopwatch")){ echo "active"; } ?>">
                <a href="stopwatch/"><i class="fa-regular fa-bolt"></i> <br>
                    <p><?php echo $top_nav[$language][2]; ?></p>
                </a>
            </li>
            <li class="<?php if(str_contains($_SERVER['REQUEST_URI'], "/time/")){ echo "active"; } ?>">
                <a href="time/">
    ...
    margin-bottom: 5px;" alt="">
        ...
        <li class="<?php if(str_contains($_SERVER['REQUEST_URI'], "timer")){ echo "active"; } ?>">
            ...
            echo $top_nav[$language][1];
        ?></a></li>
        <li class="<?php if(str_contains($_SERVER['REQUEST_URI'], "stopwatch")){ echo "active"; } ?>"><a href="stopwatch/"><i class="fa-regular fa-bolt"></i><?php
        echo $top_nav[$language][2];
    ?></a></li>
    <li class="<?php if(str_contains($_SERVER['REQUEST_URI'], "/time/")){ echo "active"; } ?>"><a href="time/"><i class="fa-regular fa-clock"></i><?php
...
<?php
    ...
    <div class="body" style="display: flex; width: 100%;">
        <div class="menu" style="width: 100px; height: 100vh; background-color: #3d3c3c; position: fixed; margin-top: 5.2%;">
            ...
            <li class="<?php if(str_contains($_SERVER['REQUEST_URI'], "stopwatch")){ echo "active"; } ?>"><a href="stopwatch/"><i class="fa-regular fa-bolt"></i> <br><p><?php
            echo $top_nav[$language][2];
        ?></p></a></li>
        <li class="<?php if(str_contains($_SERVER['REQUEST_URI'], "/time/")){ echo "active"; } ?>">
...
<?php
    ...
    <div class="body" style="display: flex; width: 100%;">
        <div class="menu" style="width: 100px; height: 100vh; background-color: #3d3c3c; position: fixed; margin-top: 5.2%;">
            ...
            <li class="<?php if(str_contains($_SERVER['REQUEST_URI'], "/time/")){ echo "active"; } ?>">     <a href="time/"><i class="fa-regular fa-clock"></i><br>
                <p><?php echo $top_nav[$language][3]; ?></p>
            </a>
        </li>
    </ul>
...
<div class="menuForMobile" style="width: 70%; height: 100vh; background-color: #3d3c3c; position: fixed; z-index: 2;">
    ...
    <li class="<?php if(str_contains($_SERVER['REQUEST_URI'], 'en/timer/')){ echo "active"; } ?>">
        <a href="../timer/"><i class="fa-regular fa-circle-arrow-down"></i><?php
        echo $top_nav[$language][1];
        ?>
    </a></li>
    <li class="<?php if(str_contains($_SERVER['REQUEST_URI'], 'en/stopwatch/')){ echo "active"; } ?>">
        <a href="../stopwatch/"><i class="fa-regular fa-bolt"></i><?php
        echo $top_nav[$language][2];
        ?>
    </a></li>
    <li class="<?php if(str_contains($_SERVER['REQUEST_URI'], 'en/time/')){ echo "active"; } ?>"><a href="../time/"><i class="fa-regular fa-clock"></i><?php
    echo $top_nav[$language][3];
?></a></li>
</ul>
</div>
