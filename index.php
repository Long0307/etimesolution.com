...
<div class="content" id="content">
    <div class="box text-center" id="unset" style="background-color: white; padding-bottom: 1%; display: block;">
        ...
        <button type="button" class="btn btn-success mb-3" id="setAlarm">Set Alarm</button>
    </div>
    ...
    <div class="radialProgressBar progress-10" id="progress-10" data-progress="32%" style="--progress: 32%;">
        <div class="overlay">
            ...
            <button type="button" class="btn btn-danger mb-3" id="stopAlarm">Stop the Alarm</button>
        </div>
    </div>
</div>
<!-- =================================== -->
<div style="display: flex;" id="editFloat">
    <div class="box text-center px-3 addHeight" style="overflow-x: scroll;">
        <h4>List of recently used alarms.</h4>
  ...
  // output data of each row
                    while($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-success" id="restartAlarm_<?php echo $row['id']; ?>" onclick="return restartAlarm(<?php echo $row['id'];; ?>);">Reset</button>
                                <button type="button" onclick="return removeAlarm(<?php echo $row['id']; ?>);" class="btn btn-outline-danger"><i class="fa-solid fa-trash-can"></i>Delete</button>
                            </td>
                        </tr>
                        <?php
                        $i++;
    ...
    <div class="box text-center px-3 getHeight" style="margin-left: 2%; background-color: white; padding-bottom: 1%; margin-top: 15px; padding-top: 15px;  width: 49%; display: block; height: 100%;">
        <h4>Set alarms for specific time</h4>
        <?php
...
<div class="box text-center p-3" id="tutor" style="background-color: white; padding-bottom: 1%; margin-top: 15px; padding-top: 15px; width: 100%;">
    <h4>How to use an alarm clock online</h4>
    <p>Step 1: Click the blue button (Set Alarm) to set the alarm time below the date section. </p>
    <p>Step 2: Select the hour, minute you want the notification and sound. If you do not select the sound, the machine will automatically set the default mode sound. Next you enter the alarm name so that next time you don't have to enter the form but just choose the time in the table below after the first time (but to do this you should login or register first).</p>
    <p>Step 3: You can try by pressing the try button or press the start button to get started right away.</p>
</div>
...
">Privacy</a> | <span class="text-nowrap">© 2023 etimesolution.com</span>
</div>
</div>
...
<div class="tableEdit">
    <div class="headertable" style="width: 100%; height: 78.39px; background-color: #0090dd; padding: 20px 15px; position: absolute; border-radius: 5px 5px 0 0;">
        <h4 style="color: white;">Set notification time</h4>
        <i class="fa-solid fa-xmark" style="float: right; font-size: 28px; color: white; position: absolute; top: 25px; right: 15px;" onclick="exist();"></i>
    </div>
    <div class="bodyTable" style="width: 100%; height: auto; padding: 42px 15px 0px 15px; position: absolute; top: 14%; border-radius: 5px 5px 0 0;">
        <form action="" method="post" class="align-center">
            <div class="row">
                <div class="boxHour col-md-6 col-6">
                    <select class="form-select" name="hour" id="hour" aria-label="Default select example">
                        <option value="notvalue">Hours</option>
                        <?php
                        for ($i = 0; $i <= 23; $i++) { 
                ...
                <div class="boxHour col-md-6 col-6">
                    <select class="form-select" name="minute" id="minute" aria-label="Default select example">
                        <option value="notvalue">Minutes</option>
                        <?php
                        for ($i = 0; $i <= 59; $i++) { 
                            echo '<option value="'.$i.'">'.$i.'</option>';
                        }
            ...
            <label for="" style="padding-top: 10px;">Alarm sound: </label>
            <select class="form-select" id="soundAlarm" aria-label="Alarm sound">
