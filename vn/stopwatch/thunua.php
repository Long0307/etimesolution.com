...
<script type ="text/javascript">
    ...
    $("#stop").click(function(event) {
        clearInterval(interval, intervalForRun);
        // if (intervalForRun) {
    ...
    const lapTimer = () => {
        ...
        if(i == 1){
            ...
            intervalForRun = [setInterval(test, 10),setInterval(startWatchForRun, 10)];
                ...
                //     // Lẻ ra kết quả
                //     alert(1);
                //     // interval = setInterval(test(i), 10);
                ...
                // }else{
                   ...
                   $("#showData").after(''
                    ...
                    clearInterval(intervalForRun);
                    intervalForRun = [setInterval(test, 10),setInterval(startWatchForRun, 100)];
