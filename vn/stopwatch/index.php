            ...
            <div class="content" id="content">
                <div class="box text-center" id="unset" style="background-color: white; padding-bottom: 1%;">
                    ...
                    <div class="resetandstart">
                        ...
                        <button type="button" class="btn btn-success mb-3" id="start">Chạy</button>
                    </div>
                ...
                <div class="box text-center p-3" id="tutor" style="background-color: white; padding-bottom: 1%; margin-top: 15px; padding-top: 15px; width: 100%;">
                    <h4>Cách sử dụng một đồng hồ bấm giờ online</h4>
                    <p>Bước 1: Bấm nút Chạy, lúc đó thời gian bắt đầu chạy. Lúc đó sẽ có hai nút được bật lên là Vòng và Dừng.</p>
                    <p>Bước 2: Nếu bạn ấn vào Vòng thì quãng thời gian hoàn tất từng chu trình sẽ được ghi lại. Hoặc nếu bạn ấn vào nút Dừng thì đồng hồ sẽ ngay lập tức dừng lại. Lúc đó sẽ có nút chạy và đặt lại lại hiện ra.<p>
                    <p>Bước 3: Nếu bạn muốn xoá các mốc thời gian đã ghi bạn có thể ấn vào đặt lại hoặc tải lại trang.</p>
                </div>
