...
<div class="content" id="content">
        ...
        <div id="settingTimer" style="width: 60%;height: auto;padding: 18px 15px 0px 15px;border-radius: 5px 5px 0 0;margin: 0 auto;">
            <form action="" method="post" id="formSetting">
                <div class="row col-xs-12">
                    ...
                    <div class="boxHour col-md-4 col-xs-12">
                        <label for="minute" class="">Minutes:</label>
                ...
                <label for="" style="padding-top: 10px;">Notification sound: </label>
                <select class="form-select" id="soundAlarm" aria-label="Notification sound">
                    <option value="clock" checked>Alarm clock sound</option>
                    ...
                    <option value="bomb-explosion">Bomb explosion</option>
                ...
                <button type="button" class="btn btn-success mb-3 text-center" id="startTimer " onclick="return startTimer(); ">Start timer</button>
            </div>
        </form>
    </div>
    ...
    <div class="text-center">
        <button type="button" class="btn btn-warning text-light mb-3" id="pauseTimer" onclick="return pauseTimer();">Pause</button>
        <button type="button" class="btn btn-success mb-3" id="restartTimer">Restart</button>
        <button type="button" class="btn btn-danger mb-3" id="stopTimer">Stop</button>    
    </div>
...
<div style="display: flex; " id="editFloat">
    <div class="box text-center px-3 addHeight" style="overflow-x: scroll;">
        <h4>List of recently used timer</h4>
        <table class="table tablePC ">
            <thead>
                <tr>
                    <th scope="col">#</th>
                    <th scope="col">Name</th>
                    <th scope="col">Timing clock</th>
          ...
          // output data of each row
                    while($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-success m-2" id="restartAlarm_<?php echo $row['id']; ?>" onclick="return restartAlarm(<?php echo $row['id'];; ?>);"><?php echo $settingAction[$language][0]; ?></button>
                                <button type="button" onclick="return removeAlarm(<?php echo $row['id']; ?>);" class="btn btn-outline-danger"><i class="fa-solid fa-trash-can"></i><?php echo $settingAction[$language][2]; ?></button>
                            </td>
                        </tr>
                        <?php
                        $i++;
    ...
    <div class="box text-center px-3 getHeight" style="margin-left: 2%; background-color: white; padding-bottom: 1%; margin-top: 15px; padding-top: 15px;  width: 49%; display: block; height: 100%;">
        <h4>Set timer for specific time</h4>
...
<div class="box text-center p-3" id="tutor" style="background-color: white; padding-bottom: 1%; margin-top: 15px; padding-top: 15px; width: 100%;">
    <h4>How to set a timer online</h4>
    <p>Step 1: Set the Hours, Minutes and Seconds that you want to timer, or select any number of minutes or seconds available from the drop-down list. </p>
    <p>Step 2: Set the Alarm Sound by clicking the arrow and then selecting a sound type from the drop-down list.p>
    <p>Step 3: Set a Timer Name or use the default name available.</p>
    <p>Step 4: Click the Start Timer button to start your timer process.</p>
    <p>To set more timers, open a new browser window and repeat the steps above.</p>
</div>
